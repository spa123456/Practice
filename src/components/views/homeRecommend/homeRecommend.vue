  ...
  <el-container>
      ...
      <el-main class="recommend-song-list">
          <el-header>
            ...
            <el-col :span="2"><div class="grid-content ">为你推荐</div></el-col>
            <el-col :span="2"><div class="grid-content ">情歌</div></el-col>
            <el-col :span="2"><div class="grid-content ">节奏控</div></el-col>
            <el-col :span="2"><div class="grid-content ">网络歌曲</div></el-col>
            <el-col :span="2"><div class="grid-content ">官方歌曲</div></el-col>
            <el-col :span="2"><div class="grid-content ">经典</div></el-col>
        </el-row>
          </el-header>
        <el-main>
            <el-carousel trigger="click" height="270px" :interval=5000>
                <el-carousel-item v-for="(item,index) in pageIndex" :key="index" class="carousel_css">
    ...
    methods:{
        getmusiclist(){
            ...
            this.$axios.get(url).then(res => {
                ...
                let num = Math.ceil(this.musiclistdata.length/this.pageSize)
                for (let index = 0; index < this.musiclistdata.length; index++) {
                    this.element = this.musiclistdata[index].cover; 
                    this.imgurl.push(this.element)     
                }
                this.pageIndex = num
        ...
        getCurrentPageData(){
            ...
            this.currentPageimgurldata = this.imgurl.slice(begin,end)         
        }
    }
}
</script>
