<template>
    <el-container style="width:100%">
        <el-header style="width:80%;margin:0 auto">
            <el-carousel :interval="5000" style="width:50%;margin:0 auto">
                ...
                <el-table :data="currentPageData" style="width: 80%;margin:0 auto">
                    ...
                    <el-table-column align="center" label="大头贴">
                        <template slot-scope="scope">
                            <span>{{scope.row.Fsinger_mid}}</span>
                            <el-avatar shape="square" :size="100"  src='https://y.gtimg.cn/music/photo_new/T001R300x300M000002J4UUk29y8BY.jpg?max_age=2592000'></el-avatar>
                        </template>
                    </el-table-column>
                </el-table>
            </el-main>
...
export default {
    ...
    methods: {
        ...
        getCurrentPageData() {
            ...
            this.currentPageData = this.singerIdData.slice(begin, end);
        },
